(() => {
  ...
  const CARDS_TYPES = ["C", "H", "D", "S"],
        CARDS_SPECIAL = ["A", "J", "Q", "K"],
        CARD_PATH = (card) => `assets/cartas/${card}.png`;

  // SELECTORES HTML
  const cartasJugador = document.querySelector("#player-cards"),
        cartasPC = document.querySelector("#pc-cards"),
        btnPedirCarta = document.querySelector("#req-btn"),
        btnPararJuego = document.querySelector("#stop-btn"),
        btnIniciarJuego = document.querySelector("#start-btn"),
  ...
  const checkResultado = (playerPoints, pcPoints) => {
    const resText = document.createElement("h4");
